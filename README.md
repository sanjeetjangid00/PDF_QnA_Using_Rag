# 📄 PDF QnA Chatbot 🤖
A Streamlit-powered chatbot that lets you ask questions from any PDF document using LangChain, OpenAI's OOS 20b (via Generative AI), FAISS, and Hugging Face Embeddings. Just upload your PDF, and start chatting with your documents in real-time!
...
✅ Question-answering via OpenAI's OOS 20b LLM
...
| OpenAI's OOS 20b (via `langchain_groq`) | Powerful LLM for QA                        |
...
- Builds a QA chain using OpenAI's OOS 20b as the LLM.
